...
TEST_CASE("round doubles with double accuracy", "[round]")
{
...
TEST_CASE("round_down ints", "[round_down]")
{
...
TEST_CASE("round_down doubles", "[round_down]")
{
...
TEST_CASE("round_down doubles with double accuracy", "[round_down]")
{
...
TEST_CASE("round_up ints", "[round_up]")
{
...
TEST_CASE("round_up doubles", "[round_up]")
{
...
TEST_CASE("round_up doubles with double accuracy", "[round_up]")
{
